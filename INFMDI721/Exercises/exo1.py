...
def pigLatin(text):
    ...
    for word in wordsArray:
        piglatinArray.append(word[1:]+word[len(word)]+"ay")
    for k in piglatinArray:
        answer += str(k+" ")
    print(answer)
...
def flatten():
    ...
    for record in response['record']:
        computed_record = {}
        computed_record['timestamp'] = computed_record['record_timestamp']
        computed_record['auteur'] = computed_record['fields']['auteur']
        computed_record['nombre_de_reservations'] = computed_record['fields']['nombre_de_reservations']
